                ...
                if (locationManager!=null){
                    ...
                    if (location!=null){
                      ...
                      //  Log.e("longitude",location.getLongitude()+"");
                        ...
                        Globalclass.latss = latitude+"";
                        Globalclass.longss = longitude+"";
                      //  Toast.makeText(Offlinegpslatlongps.this,Globalclass.latss + "" + Globalclass.longss,Toast.LENGTH_LONG).show();
                        fn_update(location);
                    }
                }

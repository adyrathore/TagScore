...
public class VolleyMultipartRequestUpload extends Request<NetworkResponse> {
    ...
    public VolleyMultipartRequestUpload(int method, String url,
                                        Response.Listener<NetworkResponse> listener,
                                        Response.ErrorListener errorListener, MultipartProgressListener multipartProgressListener) {
